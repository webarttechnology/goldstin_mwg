	...
	<div class="gallery-navigation-carousel horizontal always">
		...
		foreach ( $gallery as $slide ) {
			...
			<div class="wcgs-thumb">
				<img alt="<?php echo esc_html( $slide['alt_text'] ); ?>" data-cap="<?php echo esc_html( $slide['cap'] ); ?>" src="<?php echo esc_url( $slide['thumb_url'] ); ?>" data-image="<?php echo esc_url( $slide['full_url'] ); ?>" width="<?php echo esc_attr( $slide['thumbWidth'] ); ?>" height="<?php echo esc_attr( $slide['thumbHeight'] ); ?>" />
			</div>
				<?php
			}
		}
			...
			foreach ( $gallery as $slide ) {
				if ( isset( $slide['full_url'] ) && ! empty( $slide['full_url'] ) ) {
					...
					<a class="wcgs-slider-image" data-fancybox="view" href="<?php echo esc_url( $slide['full_url'] ); ?>">
						<img alt="<?php echo esc_html( $slide['alt_text'] ); ?>" data-cap="<?php echo esc_html( $slide['cap'] ); ?>" src="<?php echo esc_url( $slide['url'] ); ?>" data-image="<?php echo esc_url( $slide['full_url'] ); ?>" width="<?php echo esc_attr( $slide['imageWidth'] ); ?>" height="<?php echo esc_attr( $slide['imageHeight'] ); ?>"  />
					</a>
					<?php
				}
			}
