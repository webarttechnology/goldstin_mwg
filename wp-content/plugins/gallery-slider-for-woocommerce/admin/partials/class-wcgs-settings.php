	...
	public static function options( $prefix ) {
		WCGS::createOptions(
			...
			array(
				...
				'sticky_header'      => true,
				'show_sub_menu'      => false,
				'footer_credit'      => __( 'If you like <strong>Gallery Slider for WooCommerce</strong>, please leave us a <a href="https://wordpress.org/support/plugin/gallery-slider-for-woocommerce/reviews/?filter=5#new-post" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. Your Review is very important to us as it helps us to grow more.', 'gallery-slider-for-woocommerce' ),
				'footer_after'       => "<div id='BuyProPopupContent' style='display: none;'>
				<div class='wcgs-popup-content'><h2> <i class='sp_wgs-icon-lock'></i> Available in Pro</h2><p>" . __( 'Please upgrade to the Pro version  to unlock all these amazing features.', 'gallery-slider-for-woocommerce' ) . "</p> <p><a href='" . esc_url( WOO_GALLERY_SLIDER_PRO_LINK ) . "' target='_blank' class='btn'>" . __( 'Get the Pro version', 'gallery-slider-for-woocommerce' ) . '</a></p></div></div><div id="myOnPageContent" style="display: none;"> <div class="wcgs-popup-content"><h2> <i class="sp_wgs-icon-lock"></i> Available in Pro</h2><p>Please upgrade to the Pro version  to unlock all these amazing features</p> <p><a target="_blank" href=' . esc_url( WOO_GALLERY_SLIDER_PRO_LINK ) . ' class="btn">Get the Pro version</a></p></div> </div>',
			)
		);
