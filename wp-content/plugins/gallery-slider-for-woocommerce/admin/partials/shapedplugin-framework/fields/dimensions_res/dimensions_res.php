	...
	class WCGS_Field_dimensions_res extends WCGS_Fields {
		...
		public function render() {
			...
			$args = wp_parse_args(
				$this->field,
				array(
					'width_icon'   => '<i class="icon-laptop"></i>',
			...
			if ( ! empty( $args['width'] ) ) {
				...
				echo ( ! empty( $args['width_icon'] ) ) ? '<span class="wcgs--label wcgs--label-icon sp_wgs-icon-laptop-1"></span>' : '';
			...
			if ( ! empty( $args['height'] ) ) {
				...
				echo '<div class="wcgs--input">';
				echo ( ! empty( $args['height_icon'] ) ) ? '<span class="wcgs--label wcgs--label-icon sp_wgs-icon-tablet-1"></span>' : '';
			...
			if ( ! empty( $args['height2'] ) ) {
				...
				echo '<div class="wcgs--input">';
				echo ( ! empty( $args['height2_icon'] ) ) ? '<span class="wcgs--label wcgs--label-icon sp_wgs-icon-mobile"></span>' : '';
