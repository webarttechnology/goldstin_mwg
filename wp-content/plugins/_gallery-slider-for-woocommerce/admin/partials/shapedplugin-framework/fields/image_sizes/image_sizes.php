		...
		public function render() {
			...
			if ( woo_gallery_slider_pro_is_activate() ) {
				$sizes = array_merge(
					$sizes,
					array(
						'full'   => __( 'Original uploaded image', 'woo-gallery-slider' ),
						'custom' => __( 'Set custom size', 'woo-gallery-slider' ),
					)
				);
			} else {
				$sizes = array_merge(
					...
					array(
						'full'   => __( 'Original uploaded image', 'woo-gallery-slider' ),
						'custom' => __( 'Set custom size(Pro)', 'woo-gallery-slider' ),
					)
				);
			}
			...
			if ( ! empty( $sizes ) ) {
				...
				if ( ! empty( $sizes ) ) {
					...
					echo ( ! empty( $this->field['empty_message'] ) ) ? $this->field['empty_message'] : esc_html__( 'No image sizes found.', 'woo-gallery-slider' );
