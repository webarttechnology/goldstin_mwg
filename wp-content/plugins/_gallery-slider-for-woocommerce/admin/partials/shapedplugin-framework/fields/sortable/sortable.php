 ...
 *
 */
if( ! class_exists( 'WCGS_Field_sortable' ) ) {
  class WCGS_Field_sortable extends WCGS_Fields {
    ...
    public function render() {
      ...
      foreach( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="wcgs--sortable-item">';

          echo '<div class="wcgs--sortable-content">';
          ...
          WCGS::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="wcgs--sortable-helper"><i class="fa fa-arrows"></i></div>';
