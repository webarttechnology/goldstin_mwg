 ...
 *
 */
if( ! class_exists( 'WCGS_Field_link_color' ) ) {
  class WCGS_Field_link_color extends WCGS_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'woo-gallery-slider' ),
        'hover'    => esc_html__( 'Hover', 'woo-gallery-slider' ),
        'active'   => esc_html__( 'Active', 'woo-gallery-slider' ),
        'visited'  => esc_html__( 'Visited', 'woo-gallery-slider' ),
        'focus'    => esc_html__( 'Focus', 'woo-gallery-slider' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="wcgs--title">'. $color_prop_value .'</div>';
          echo '<input type="text" name="'. $this->field_name('['. $color_prop_key .']') .'" value="'. $value[$color_prop_key] .'" class="wcgs-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
